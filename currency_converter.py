...
button = Button(main, text="Converter", width=10, padx=5, height=1, bg=cor2, fg=cor0,font=("Ivy 12 bold"), command=convert)
button.place(x=20, y=210)

button = Button(main, text="Reset", width=10, padx=5, height=1, bg=cor2, fg=cor0,font=("Ivy 12 bold"), command=Reset)
